...
## Calculate sobel_x using a prepared function filter2D in OpenCV and kernel_x ##
sobel_x = cv2.filter2D(src, src, kernel_x)
## Calculate sobel_y using a prepared function filter2D in OpenCV and kernel_y ##
sobel_y = cv2.filter2D(src, src, kernel_y)
